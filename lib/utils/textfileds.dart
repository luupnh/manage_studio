  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: Theme(
          data: Theme.of(context).copyWith(colorScheme: Theme.of(context).colorScheme.copyWith(primary: ColorsCustom.primaryColor)),
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                ...
                borderSide: isError
                    ...
                    : const BorderSide(color: ColorsCustom.primaryColor, width: 1),
              ),
